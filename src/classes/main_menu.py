...
class MainMenuBackground():
    ...
    # displays the moving background
...
class MainMenuQuit():
    def __init__(self, text:str, bg_img:tuple, surfacex:int, surfacey:int, scale:float):
        ...
        # x and y values of lines of text
        ...
        # resize shadows of text buttons
        ...
        # delay for returning new return value
        self.delay = False
    ...
    def display(self, surface:tuple):
        ...
        # delays the return of new return value
        if self.delay:
...
class MainMenu():
    def __init__(self, surfacex:int, surfacey:int, surface:tuple):
        ...
        # plays the music for main menu
        music.Music.main_menu_music.play(-1)

        # groupname and version text
        ...
        self.version = self.groupname_font.render("Version 0.02", False, (255, 255, 255))

        # text button renders for main menu
        ...
        # scale size of the text buttons
        self.scale_size = 1.2

        # default x value of the buttons
        self.default_butt_x1 = surfacex/2

        # sets the offset of the buttons depending on screen size
        if self.surfacex == self.surfacey:
            self.offset = int(15 * self.scale_size)
        else:
            self.offset = int(9.5 * self.scale_size)

        # seconde x value of the buttons
        ...
        # delays the activation of buttons
