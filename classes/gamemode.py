...
class VsBot():
    def __init__(self, surfacex:int, surfacey:int, surface:tuple):
        ...
        # load the img assets
        self.bg_img = pygame.image.load("assets/imgs/maingame/game_bg2.png").convert_alpha()
...
class PvP():
    def __init__(self, surfacex:int, surfacey:int, surface:tuple):
        ...
        # load the img assets
        self.bg_img = pygame.image.load("assets/imgs/maingame/game_bg1.png").convert_alpha()
